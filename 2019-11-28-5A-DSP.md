...
process = _*(ingain)process = _*(ingain) : inmeter <: hgroup("[01]MAIN", qaqf,er8comb: _,_,_,_,_,_,_,_,fbdel)  :> vgroup("[03]OUTPUT METERS", h1meter,h2meter,h3meter,h4meter) :> _,_ ; : inmeter <: _,_ ;
